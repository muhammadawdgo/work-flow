...
const nodes = ref([
  { id: '1', type: 'input', label: 'Mobile Bff', position: { x: 250, y: 0 }, class: 'light' },
  { id: '2', type: 'output', label: 'Fail Response', position: { x: 100, y: 100 }, class: 'light' },
...
<style>
@import 'https://cdn.jsdelivr.net/npm/@vue-flow/core@1.32.1/dist/style.css';
@import 'https://cdn.jsdelivr.net/npm/@vue-flow/core@1.32.1/dist/theme-default.css';
